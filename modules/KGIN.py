...
class GraphConv(nn.Module):
    ...
    def _cul_cor(self):
        ...
        def DistanceCorrelation(tensor_1, tensor_2):
            ...
            a, b = torch.sqrt(torch.max(tensor_1_square - a_ + tensor_1_square.t(), zeros) + 1e-8), \
                   torch.sqrt(torch.max(tensor_2_square - b_ + tensor_2_square.t(), zeros) + 1e-8) 
    ...
    def forward(self, user_emb, entity_emb, latent_emb, edge_index, edge_type,
        ...
        entity_res_emb = entity_emb  # [n_entity, channel] channel = emb_size
